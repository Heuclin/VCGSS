...
// //-------------------------------------------------------------------------------------------------
// // [[Rcpp::export]]
// List glVcmCpp(arma::mat Y, arma::mat X, List settings, List init) {
//   //
//   //
//   //
//   //  Input :
...
// //-------------------------------------------------------------------------------------------------
// // [[Rcpp::export]]
// List ssVcmWithoutRhoCpp(arma::mat Y, arma::mat X, List settings, List init, std::string var_gp) {
//   //
//   //
//   //
//   //  Input :
